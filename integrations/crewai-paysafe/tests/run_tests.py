...
from crewai_paysafe import (  # noqa: E402
    PAYSAFE_TOOL_NAMES,
    guarded_payment,
    paysafe_tools,
...
print("\n— provenance hook —")
client = FakeClient()
hook = register_paysafe_provenance(client, max_chars=50)
...
hook(HookContext("paysafe_scan_payment", json.dumps({"scan_id": "x", "verdict": "allow"})))
